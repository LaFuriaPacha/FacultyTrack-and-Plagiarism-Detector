...
$query = "SELECT grade_book.student_id, grade_book.activity_id, grade_book.grade, grade_book.id, student.first_name, student.last_name FROM grade_book INNER JOIN student ON grade_book.student_id = student.student_id"; 
...
<body> 
	<center>
 <div class="content">	
	<h1 style="color:blue;font-size: 35;"><i>GRADES INFORMATION</i> </h1>
...
<tr>
	...
	<td align="center">
		<?php echo "<a onClick=\" javascript:return confirm('Are you sure to delete? ');\" href='deletegrade.php?id={$row['id']}'>Delete</a>"; ?></td>
	<td align="center">
		<?php echo "<a href='updategrade_book.php?id={$row['id']}'> Update </a>"; ?></td>	
</tr>
<?php
}
?>
